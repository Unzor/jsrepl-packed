...
# Add to site 
First, download the [JSRepl-packed.zip](https://github.com/Unzor/jsrepl-packed/raw/main/jsrepl-packed.zip) archive and extract it in a webserver. Once finished, you may now use the compiled library like this to interpret a language:
```html
<!DOCTYPE HTML>
<html>
 <head>
